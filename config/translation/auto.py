...
from .aws import AmazonTranslate
...
class ModelTranslator():
        ...
        return reduce(
            ...
            [
                (
                    ...
                    ~Q(reduce(
                        lambda acc, f: acc & f,
                        [_get_not_empty_query(field, lang) for lang in settings.AVAILABLE_LANGUAGES]
                    )) &
    ...
    def show_characters_counts(cls):
        ...
        logger.info(f'Languages: {settings.AVAILABLE_LANGUAGES}')
        ...
        logger.info(f'Estimated Cost: {(len(settings.AVAILABLE_LANGUAGES) -1) * total_count * 0.000015}')
