...
CustomErrorType = strawberry.scalar(
    NewType("CustomErrorType", object),
...
class ArrayNestedErrorType:
    ...
    objectErrors: Optional[List[Optional[CustomErrorType]]]
...
class _CustomErrorType:
    field: str
    messages: Optional[str]
    objectErrors: Optional[
        List[Optional[CustomErrorType]]
    ]
    arrayErrors: Optional[
        List[Optional[ArrayNestedErrorType]]
    ]
